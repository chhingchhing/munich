    ...
    <tbody class="sub_acc_pk_body tbl_bodyacc<?php echo $accID; ?>">
		...
		?>
				<tr class="real_sub_acc_pk remove<?php echo $subacc["acc_id"]; ?>">
					<td>
                        <?php echo form_checkbox(array('class' => 'check_checkbox','id' => 'check_checkbox', 'name' => 'subacc_checkbox['.$accID.']['.$subacc["acc_id"].']', "checked" => true ), $subacc["acc_id"] );  ?>
                        <?php echo form_hidden('OldSubAcc['.$subacc["acc_id"].']', $subacc["acc_id"]);  ?>
                    </td>
