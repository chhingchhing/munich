    ...
    <tbody class="ep_pk_body tbl_bodyactep<?php echo $actID; ?>">
        ...
        ?>
                <tr class="real_ep_pk remove<?php echo $epact['ep_id']; ?>">
                    <td>
                        <?php echo form_checkbox(array('class' => 'check_checkbox','id' => 'check_checkbox', 'name' => 'epact_checkbox['.$actID.']['.$epact['ep_id'].']', "checked" => true), $epact['ep_id'] );  ?>
                        <?php echo form_hidden('OldEpAct['.$epact['ep_id'].']', $epact['ep_id']);  ?>
                    </td>
