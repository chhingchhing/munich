    ...
    <tbody class="ep_pk_body tbl_bodytpsep<?php echo $tpsID; ?>">
        ...
        ?>
                <tr class="real_ep_pk remove<?php echo $eptps['ep_id']; ?>">
                    <td>
                        <?php echo form_checkbox(array('class' => 'check_checkbox','id' => 'check_checkbox', 'name' => 'eptps_checkbox['.$tpsID.']['.$eptps['ep_id'].']', "checked" => true), $eptps['ep_id'] );  ?>
                        <?php echo form_hidden('OldEpTp['.$eptps['ep_id'].']', $eptps['ep_id']); ?>
                    </td>
