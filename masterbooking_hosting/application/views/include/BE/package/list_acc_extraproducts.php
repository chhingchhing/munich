    ...
    <tbody class="ep_pk_body tbl_bodyaccep<?php echo $accID; ?>">
        ...
        ?>
                <tr class="real_ep_pk remove<?php echo $epacc['ep_id']; ?>">
                    <td>
                        <?php echo form_checkbox(array('class' => 'check_checkbox','id' => 'check_checkbox', 'name' => 'epacc_checkbox['.$accID.']['.$epacc['ep_id'].']', "checked" => true), $epacc['ep_id'] );  ?>
                        <?php echo form_hidden('OldEpAcc['.$epacc['ep_id'].']', $epacc['ep_id']); ?>
                    </td>
