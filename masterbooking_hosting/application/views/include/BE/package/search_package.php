...
<div class="container-fluid clearfix">
    <div class="col-md-8 column search">
     <?php
        ...
        echo form_input(array('name' => 'search_package_name','value' => set_value('search_name', $this->session->userdata('search_package')), 'class' => 'form-control input-sm', 'placeholder' => 'Package Name'));
        echo '</div> &nbsp;';
...
<div class="container-fluid clearfix">
  <table class="table table-striped table-hover table-bordered">
    <tr>
      ...
      <th><?php echo anchor("package/list_record/start_date/" . $sort, "From Date"); ?></th>
      <th><?php echo anchor("package/list_record/end_date/" . $sort, "To Date"); ?></th>
      <th>Location</th>
      <th>Fastival</th>
      <th>Purchase($)</th>
      <th>Sale($)</th>
