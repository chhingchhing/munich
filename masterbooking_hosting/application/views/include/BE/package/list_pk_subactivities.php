    ...
    <tbody class="sub_act_pk_body tbl_bodyact<?php echo $actID; ?>">
		...
		?>
				<tr class="real_sub_act_pk remove<?php echo $subact["act_id"]; ?>">
					<td>
                        <?php echo form_checkbox(array('class' => 'check_checkbox','id' => 'check_checkbox', 'name' => 'subact_checkbox['.$actID.']['.$subact["act_id"].']', "checked" => true ), $subact["act_id"] );  ?>
                        <?php echo form_hidden('OldSubAct['.$subact["act_id"].']', $subact["act_id"]);  ?>
                    </td>
