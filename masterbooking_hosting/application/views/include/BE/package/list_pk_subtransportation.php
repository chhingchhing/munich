    ...
    <tbody class="sub_tps_pk_body tbl_bodytps<?php echo $tpsID; ?>">
		...
		?>
				<tr class="real_sub_tps_pk remove<?php echo $subtps["tp_id"]; ?>">
					<td>
                        <?php echo form_checkbox(array('class' => 'check_checkbox','id' => 'check_checkbox', 'name' => 'subtps_checkbox['.$tpsID.']['.$subtps["tp_id"].']', "checked" => true ), $subtps["tp_id"] );  ?>
                        <?php echo form_hidden('OldSubTp['.$subtps["tp_id"].']', $subtps["tp_id"]);  ?>
                    </td>
