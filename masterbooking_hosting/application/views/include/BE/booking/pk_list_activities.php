	...
	<div class="panel panel-default">
		<div class="panel-heading">
	      <div class="panel-title">
	        ...
	        <span class="icon-list-alt pkadd clickDetailact" data-url="<?php echo base_url(); ?>package/actdetail/<?php echo $actID; ?>/<?php echo $pgID; ?>" data-toggle='modal' data-target='.modalDetials' title="Details" style="float:right; margin-left:5px;"></span>
