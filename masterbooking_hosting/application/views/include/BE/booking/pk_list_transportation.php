	...
	<div class="panel panel-default">
		<div class="panel-heading">
	      <div class="panel-title">
	        ...
	        <span class="icon-list-alt pkadd clickDetailtp" data-url="<?php echo base_url(); ?>package/tpdetail/<?php echo $tpsID; ?>/<?php echo $pgID; ?>" data-toggle='modal' data-target='.modalDetials' title="Details" style="float:right; margin-left:5px;"></span>
