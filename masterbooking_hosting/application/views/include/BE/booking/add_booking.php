...
<div class="row">
    ...
    <div class="form-group col-sm-12">
        ...
        <div class="col-sm-4">
            ...
            <?php echo form_input(array('name' => 'bkDate','data-date-format'=>'yyyy-mm-dd', 'value' => set_value('bkDate'), 'class' => 'bkDate form-control', 'id' => 'bkDate','placeholder'=>'YYYY-MM-DD')); ?>
    ...
    <div class="form-group col-sm-12">
        ...
        <div class="col-sm-4">
            <?php echo form_input(array('name' => 'bkArrivalDate','data-date-format'=>'yyyy-mm-dd', 'value' => set_value('bkArrivalDate'), 'class' => 'bkArrivalDate form-control', 'id' => 'bkArrivalDate','placeholder'=>'YYYY-MM-DD')); ?>
    ...
    <!-- <div class="form-group col-sm-12">
        ...
        <div class="col-sm-4">
            <?php // echo form_input(array('name' => 'bkReturnDate','data-date-format'=>'yyyy-mm-dd', 'value' => set_value('bkReturnDate'), 'class' => 'bkReturnDate form-control', 'id' => 'bkReturnDate','placeholder'=>'YYYY-MM-DD')); ?>
    ...
    <div class="form-group col-sm-12">
        ...
        <div class="col-sm-4">
            <?php echo form_input(array('name' => 'bkbalance', 'value' => set_value('bkbalance'), 'class' => 'bkbalance form-control', 'id' => 'bkbalance','placeholder'=>'enter balance price')); ?>
    ...
    <div class="form-group col-sm-12">
        ...
        <div class="col-sm-4">
            <?php echo form_input(array('name' => 'bkdeposit', 'value' => set_value('bkdeposit'), 'class' => 'bkdeposit form-control', 'id' => 'bkdeposit','placeholder'=>'enter desposit price')); ?>
    ...
    <div class="form-group col-sm-12">
        ...
        <div class="col-sm-4">
            <?php echo form_input(array('name' => 'bkPayDate','data-date-format'=>'yyyy-mm-dd', 'value' => set_value('bkPayDate'), 'class' => 'bkPayDate form-control', 'id' => 'bkPayDate','placeholder'=>'YYYY-MM-DD')); ?>
