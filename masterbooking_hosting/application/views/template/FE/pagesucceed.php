...
<!-- Personal Information of each passenger-->
	<h4 class="infoheader">Add Information to All Passengers</h4>
<?php 
	if(isset($errornp)){
?>
	<div class="alert alert-warning alert-dismissable">
	  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	  <span><?php echo $errornp; ?></span>
	</div>
...
?>
		<table class="tb">
			<tr>
				...
				<td><span class="txtError"><?php echo form_error('fname'); ?></span></td>
			</tr>
			<tr>
				...
				<td><span class="txtError"><?php echo form_error('lname'); ?></span></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><span class="txtError"><?php echo form_error('uemail'); ?></span></td>
			</tr>
			<tr>
				...
				<td><span class="txtError"><?php echo form_error('phone'); ?></span></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><span class="txtError"><?php echo form_error('country'); ?></span></td>
			</tr>
			<tr>
				...
				<td><span class="txtError"><?php echo form_error('city'); ?></span></td>
			</tr>
			<!-- <tr>
			...
			<tr>
				...
				<td><span class="txtError"><?php echo form_error('address'); ?></span></td>
			</tr>
			<tr>
...
<?php echo form_close(); ?>
	...
	<div class="col-lg-4">
	<h4 class="infoheader">Booking Information</h4>
		<?php 
			if(isset($getbooking)){
